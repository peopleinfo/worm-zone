...
export const MAP_ZOOM_LEVEL = 4.5;
...
export const TARGET_FPS = 45; // Configurable FPS between 30-45
...
export const SHADOW_BLUR = 3; // Shadow blur radius in pixels
export const SHADOW_OFFSET_X = 2; // Shadow horizontal offset
export const SHADOW_OFFSET_Y = 2; // Shadow vertical offset
export const SHADOW_COLOR = 'rgba(0, 0, 0, 0.7)'; // Shadow color with transparency

// Snake Configuration
export const BODY_SEGMENT_SPACING = 0.6; // Spacing between snake body segments