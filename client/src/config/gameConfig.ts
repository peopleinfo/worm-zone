...
export const TARGET_FPS = 35; // Configurable FPS between 30-40
export const FORCE_FPS_LIMIT = true; // Enable/disable forced FPS limiting
export const MIN_FPS = 30; // Minimum allowed FPS
...
export const SHADOW_COLOR = 'rgba(0, 0, 0, 0.3)'; // Shadow color with transparency